...
func TestDisplayTitleUsesPrimaryArgument(t *testing.T) {
	tests := []struct {
		...
		{name: "read", call: model.ToolCall{Name: "read", Arguments: `{"path":"README.md"}`}, want: "Read: README.md"},
		{name: "edit", call: model.ToolCall{Name: "edit", Arguments: `{"path":"README.md","edits":[]}`}, want: "Edit: README.md"},
		{name: "write", call: model.ToolCall{Name: "write", Arguments: `{"path":"README.md","content":"text"}`}, want: "Write: README.md"},
