...
func TestBuildSystemIncludesCoreBehavior(t *testing.T) {
	...
	checks := []string{
		...
		"Use run_shell for path discovery, text search, bounded file inspection",
		"Pass success_exit_codes [0,1] for rg searches",
		"Keep shell-based file inspection bounded",
		"Get-Content piped to Select-Object",
		"Use apply_patch for direct, manual text edits",
		"ad hoc scripts merely to bypass apply_patch",
		"Project-owned formatters, generators, package managers, and migration commands",
