...
核心实现位于 `internal/agent`、`internal/runtime`、`internal/model`、`internal/provider/openai`、`internal/tool`、`internal/prompt`、`internal/config`、`internal/session` 和 `internal/transcript`。CLI 位于 `cmd/atlas`。
